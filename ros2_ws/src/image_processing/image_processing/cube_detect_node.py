...
class CubeDetectNode(Node):
    ...
    def __init__(self):
        ...
        self.cv_sub = self.create_subscription(CVStates, "scan_blocks", self.cv_callback, 10)
    ...
    def cv_callback(self, scan_msg: CVStates):
        ...
        if scan_msg.wall:
            ...
            if scan_msg.yolo:
                ...
                ##
                results = self.model.predict(cur_frame, imgsz=(480,640),verbose=False, classes=[0,1])
                ...
                cube_info_msg.x_lefts = x_left_list
                cube_info_msg.y_tops = y_top_list
